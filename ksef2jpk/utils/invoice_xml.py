...
def _has_descendant(root, name: str) -> bool:
...
def classify_ksef_invoice_xml(path: str | Path) -> dict:
    ...
    schema = {
        "logical_name": "FA(3)" if namespace == KSEF_FA3_NAMESPACE else "unknown",
        "namespace": namespace,
    }
    ...
    return {"ok": True, "reason": "KSeF invoice XML", "schema": schema}
